...
public class ObservableOriginatorServer extends ObservableServer
{
  ...
  {
    setChanged();
    ((SplitOriginatorMessage) message).setOriginator(client);
  ...
  {
    setChanged();
    notifyObservers(new SplitOriginatorMessage(client, CLIENT_CONNECTED,null, null));
  }
  ...
  {
    setChanged();
    notifyObservers(new SplitOriginatorMessage(client, CLIENT_DISCONNECTED,null, null));
  }
    ...
    ConnectionToClient client, Throwable exception)
  {
    ...
    notifyObservers(
      new SplitOriginatorMessage(client,
        CLIENT_EXCEPTION + exception.getMessage(),null, null));
  }
  ...
  protected synchronized void listeningException(Throwable exception)
  {
    ...
    notifyObservers(
      new SplitOriginatorMessage(null,
        LISTENING_EXCEPTION + exception.getMessage(),null, null));
  }
  ...
  {
    setChanged();
    notifyObservers(new SplitOriginatorMessage(null, SERVER_STARTED,null, null));
  }
  ...
  {
    setChanged();
    notifyObservers(new SplitOriginatorMessage(null, SERVER_STOPPED,null, null));
  }
  ...
  {
    setChanged();
    notifyObservers(new SplitOriginatorMessage(null, SERVER_CLOSED, null, null));
  }
}
