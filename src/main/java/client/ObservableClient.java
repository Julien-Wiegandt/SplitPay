...
// ACCESSING METHODS ------------------------------------------------
  ...
  {
    setChanged();
    notifyObservers(new SplitOriginatorMessage(null,CONNECTION_CLOSED,null,null));
  }
  ...
  {
    setChanged();
    notifyObservers(new SplitOriginatorMessage(null,CONNECTION_ESTABLISHED,null,null));
  }
}
